...
public class Encryption {
	...
	public boolean validatePassword(String password, String userPassword)
		...
		return validatePassword(password.toCharArray(), userPassword);
	}
	 ...
	 * @return true if the password is correct, false if not
	 */
	public boolean validatePassword(char[] password, String userPassword)
			throws NoSuchAlgorithmException, InvalidKeySpecException {
		// Decode the hash into its parameters
		String[] params = userPassword.split(":");
	 ...
	 * @param testHash the second byte array
	 * @return true if both byte arrays are the same, false if not
	 */
	private boolean slowEquals(byte[] hash, byte[] testHash) {
